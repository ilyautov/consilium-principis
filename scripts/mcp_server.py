...
12. КАРТА РЕШЕНИЯ («📐 расчёт»). Юзер принёс вопрос-РЕШЕНИЕ (выбор из вариантов со ставкой) —
   ...
   только спрашивает; каждая величина получает confirmed_by_user=true и elicited=дословную
   цитату ОТВЕТА юзера — без этого расчёт откажет.
   ...
   (е) После расчёта ОДИН РАЗ предложи сохранить карту: согласие → save_decision_map (вернёт
