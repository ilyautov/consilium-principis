...
Провенанс глобальных дефолтов (0.50 / [0.45, 0.65]) и оговорка малого n
(2 советника × 12 камуфляж-проб → рабочие точки, не доказанные оптимумы):
docs/dev/calibration-provenance.md.
"""
import json
import os
import random
