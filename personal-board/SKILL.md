...
### Движок ретрива (тиры)
Движок ретрива выбирается автоматически (resolve_engine): FULL (ollama bge-m3) если доступен,
иначе SIMPLE-пол (лексика, 0 установки). Защитный контур (fidelity, verbatim-чек) работает на
ЛЮБОМ тире — деградирует только качество ретрива, не честность. Диагностика тира на машине:
