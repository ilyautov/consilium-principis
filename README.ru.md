...
Установщик по двойному клику ([`install.bat`](install.bat)) и mcpb-бандл работают из коробки — они запускаются через Python Launcher `py`. Два нюанса именно для Windows:
