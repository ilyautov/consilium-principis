...
Каждая 🔵-цитата сверена с подлинным текстом автора **слово-в-слово**; чего в корпусе нет —
...
автора слово-в-слово, а вне корпуса советник честно молчит, а не выдумывает** (fail-closed). Это
...
корпусом автора кодом, слово-в-слово**, и несёт источник. Не нашлось точной строки — советник
...
> ⚖️ **Граница.** Consilium — **движок верности, не распространитель**: он даёт машинерию, источники
> приносишь ты. Навык не качает копирайтные книги: public-domain — свободно; копирайт — только твои
> легальные копии, и они остаются на твоей машине. Готовыми мы сеем только фигуры общественного
> достояния, давно умершие; современного советника ты собираешь себе сам. Твоя доска (`advisors/`) и
> твой профиль — личные данные, в репозиторий не уходят.
