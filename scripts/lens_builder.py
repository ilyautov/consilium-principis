"""Интерактивный билдер линз (направление «линзы > личности», docs/dev/2026-06-30-lenses-over-
personalities.md). Линза = advisor-каталог; строится тем же corpusbuild.pipeline. Три конфигурации
